    ...
    >
      <label className="block">
        ...
        <input
          ...
          className="mt-1 block w-full field bg-slate-900 px-3 py-2 text-sm"
          spellCheck={false}
        />
      </label>
      ...
      <div className="space-y-4">
        ...
        >
          <input
            ...
            className="block w-full field bg-slate-900 px-3 py-2 text-center font-mono text-lg tracking-widest"
            spellCheck={false}
          />
          <button
            type="submit"
